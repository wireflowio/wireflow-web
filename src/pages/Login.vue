...
<template>
  <div
    ...
    <div
        class="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-0 rounded-[3rem] overflow-hidden shadow-2xl shadow-blue-500/5 border border-slate-200/60 dark:border-white/5 bg-base-100/40 dark:bg-slate-900/40 backdrop-blur-2xl relative z-10">
      ...
      <div class="relative p-12 lg:p-16 flex flex-col justify-between border-r border-slate-200/60 dark:border-white/5">
        <div>
          <div class="flex items-center gap-4 mb-20">
            ...
            <span class="text-2xl font-black tracking-tighter text-base-content dark:text-white">Wireflow</span>
          </div>

          <h2 class="text-5xl font-black tracking-tighter text-base-content dark:text-white leading-[0.95] mb-6">
            企业级<br/>
            <span class="text-blue-600">组网控制中心</span>
          </h2>
          <p class="text-sm font-medium text-base-content/60 dark:text-base-content/40 max-w-xs leading-relaxed">
        ...
        <div class="space-y-6">
          <div class="flex items-center gap-3">
            ...
            <span class="text-[10px] font-black uppercase tracking-widest text-base-content/40">Trusted by 500+ Teams</span>
          </div>
      ...
      <div class="p-12 lg:p-16 bg-base-100/60 dark:bg-slate-900/60 backdrop-blur-xl flex flex-col justify-center">
        <div class="mb-10">
          <h3 class="text-2xl font-black tracking-tight text-base-content dark:text-white">控制面登录</h3>
          <p class="text-xs font-bold text-base-content/40 uppercase mt-1 tracking-widest">请输入您的企业凭证</p>
        </div>

        <form @submit.prevent="handleLogin" class="space-y-5">
          <div class="space-y-2">
            <label class="text-[10px] font-black uppercase tracking-widest text-base-content/40 ml-1">邮箱或用户名</label>
            <div class="relative">
              ...
              <input v-model="form.username" type="text" placeholder="name@company.com" required
                     class="w-full h-14 pl-12 pr-6 bg-slate-100/50 dark:bg-base-100/5 border-none rounded-2xl text-sm outline-none focus:ring-4 focus:ring-blue-500/10 transition-all dark:text-white"/>
            </div>
          </div>

          <div class="space-y-2">
            <div class="flex justify-between items-center ml-1">
              <label class="text-[10px] font-black uppercase tracking-widest text-base-content/40">访问密码</label>
          ...
          <div class="flex items-center gap-3 px-1">
            ...
            <span class="text-xs font-bold text-base-content/60 dark:text-base-content/40">保持登录状态</span>
          </div>
          ...
          <div class="relative my-8">
            ...
            <div class="relative flex justify-center text-[10px] font-black uppercase tracking-widest">
              <span class="bg-base-100/60 dark:bg-slate-900 px-4 text-base-content/40">快速访问</span>
            </div>
          </div>

          <div class="grid grid-cols-3 gap-4">
            <button @click="handleSocialLogin('github')" type="button" class="flex flex-col items-center justify-center gap-2 p-4 rounded-2xl bg-slate-100/50 dark:bg-base-100/5 hover:bg-slate-200/50 dark:hover:bg-base-100/10 transition-all group">
              <svg class="w-6 h-6 text-base-content dark:text-white group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>
              <span class="text-[9px] font-black uppercase tracking-tight text-base-content/60">GitHub</span>
            </button>

            <button @click="handleSocialLogin('google')" type="button" class="flex flex-col items-center justify-center gap-2 p-4 rounded-2xl bg-slate-100/50 dark:bg-base-100/5 hover:bg-slate-200/50 dark:hover:bg-base-100/10 transition-all group">
              ...
              <span class="text-[9px] font-black uppercase tracking-tight text-base-content/60">Google</span>
            </button>

            <button @click="handleSocialLogin('ldap')" type="button" class="flex flex-col items-center justify-center gap-2 p-4 rounded-2xl bg-slate-100/50 dark:bg-base-100/5 hover:bg-slate-200/50 dark:hover:bg-base-100/10 transition-all group">
              <svg class="w-6 h-6 text-base-content dark:text-white group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" stroke-linecap="round" stroke-linejoin="round"/></svg>
              <span class="text-[9px] font-black uppercase tracking-tight text-base-content/60">AD/LDAP</span>
            </button>
          </div>
        </form>

        <div class="mt-10 text-center">
          <p class="text-xs font-bold text-base-content/40">
            还没有账号?
        ...
        <div class="mt-12 pt-8 border-t border-slate-100 dark:border-white/5 flex items-center justify-between">
          <span class="text-[9px] font-black text-slate-300 dark:text-base-content/70 uppercase tracking-widest">© 2026 Wireflow Inc.</span>
          <div class="flex gap-4">
            <a href="#"
               class="text-[9px] font-black text-slate-300 dark:text-base-content/70 uppercase tracking-widest hover:text-blue-600 transition-colors">隐私政策</a>
            <a href="#"
               class="text-[9px] font-black text-slate-300 dark:text-base-content/70 uppercase tracking-widest hover:text-blue-600 transition-colors">合规文档</a>
          </div>
        </div>
      </div>
    </div>
