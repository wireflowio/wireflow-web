...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-content">
    ...
    <nav class="navbar w-full bg-base-300">
      ...
      <div class="px-4">Wireflow</div>
    </nav>
    <!-- Page content here -->
    <div class="p-4">Page Content</div>
  </div>

  <div class="drawer-side is-drawer-close:w-14  transition-all duration-300">
   
       <div class="h-20 flex items-center px-6 overflow-hidden shrink-0 is-drawer-close:hidden">
        ...
        <span class="ml-3 text-xl font-bold tracking-tight whitespace-nowrap transition-opacity duration-200 is-drawer-close:hidden">Wireflow</span>
      </div>
